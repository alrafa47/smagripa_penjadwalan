...
class DataJurusan extends CI_Controller
{
	...
	public function validation_form(){
		$this->form_validation->set_rules("id_jur", "Kode Jurusan", "required|is_unique[jurusan.id_jurusan]|max_length[5]");
	...
	{
		$this->form_validation->set_rules("id_jur", "Kode Jurusan", "required|max_length[5]");
